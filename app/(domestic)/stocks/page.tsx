...
import { getIndexDataApi } from "@/lib/index-api";
      ...
      <main className="pl-[24rem] min-h-[100vh] max-w-[1500px]">
        <section className="p-10 pt-5">
          ...
          <div className="mt-5 flex justify-between gap-5">
            <KospiChart info={kospi.output1} data={kospi.output2} />
            <KospiChart info={kosdaq.output1} data={kosdaq.output2} />
            <KospiChart info={kospi200.output1} data={kospi200.output2} />
            <KospiChart info={gobaedang.output1} data={gobaedang.output2} />
          </div>
        </section>
        <section className="px-10">
          ...
          <StockListTable data={stockRank.output} />
        </section>
