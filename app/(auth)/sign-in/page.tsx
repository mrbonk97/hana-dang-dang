...
const formSchema = z.object({
  ...
  password: z.string().min(7, {
    message: "패스워드는 특수 문자를 포함하여 7자 이상입니다.",
  }),
});
...
const SignInPage = () => {
  ...
  return (
    <main className="pt-14 h-full flex2 bg-c1-100">
      <div className="h-[90%] w-[80%] flex gap-5 rounded-2xl border shadow-xl bg-background">
        <div className="p-5 h-full w-full flex2 border-r">
